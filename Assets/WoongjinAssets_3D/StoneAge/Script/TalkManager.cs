...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        ...
        // Quest Talk
        // 퀘스트 번호 + NPC Id
        talkData.Add(10 + 1000, new string[] {  "웅진 : 저기...",
                                                "족장 : 음? 뭐야 벌써 깨어난게야?",
                                                "웅진 : 저 혹시... 여기가 어딘..",
        ...
        talkData.Add(21 + 1000, new string[] {  "족장 : 오! 석기를 완성했나?",
                                                "족장 : 음...",
        ...
        talkData.Add(30 + 1000, new string[] {  "웅진 : 무슨 일 있으신가요?",
                                                "족장 : 음...",
                                                "웅진 : ...",
                                                "족장 : ...",
                                                "웅진 : 저기...",
        ...
        talkData.Add(31 + 1000, new string[] {  "족장 : 오! 이건!",
                                                "족장 : 나뭇가지와 돌을 이어 붙였구만!",
                                                "족장 : 참으로 기발한 생각이네. 이것으로 무리원 모두가 사냥과 채집에 있어서 쉽게 할 수 있겠구만!",
                                                "족장 : 역시 내가 사람 보는 눈이 있다니까. 고생했네 고생했어!", });

        talkData.Add(40 + 1000, new string[] {  "족장 : 오! 자네인가, 마침 잘 왔네.",
                                                "족장 : 저번에 만들었던 돌도끼 말일세.",
                                                "족장 : 무리원들의 반응이 아주 좋아!",
        ...
        talkData.Add(41 + 1000, new string[] {  "족장 : 거 봐, 할 수 있으면서 엄살은.",
        ...
        talkData.Add(50 + 1000, new string[] { "족장 : 으음...",
                                                "웅진 : 저기...",
                                                "족장 : 흠...",
                                                "웅진 : 저... 할아버지.",
                                                "족장 : ...",
        ...
        talkData.Add(51 + 1000, new string[] {  "웅진 : 할아버지!!!",
                                                "족장 : 아잇, 깜짝이야!",
        ...
        talkData.Add(60 + 1000, new string[] {  "족장 : 오, 자네 왔는가?",
        ...
        talkData.Add(61 + 1000, new string[] {  "족장 : 흠... 좋아.",
